...
{
    DatesCitizen _citi; // llamando la estructura del ciudadano
	...
	void OnCollisionEnter(Collision collision)
	{
		...
		{
			Debug.Log ("Waaaarrrr quiero comer " + collision.gameObject.GetComponent<Zombie>()._zonbi.part); // mensaje que se imprime en caso de collicion con el zombie
		}
