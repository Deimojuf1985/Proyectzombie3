...
public enum Censo                                           
{
	maria, feranando, carlos, camilo, jeronimo, salvador, sara, monica, alucard, mephisto,
	tracul, elber, rosana, micahel, veronica, yaneth, maricarmen, valentina, katehrine, laura
}
//estuctura que me contiene un entero de edad y el enum para los nombres y edad de los ciudadanos  
public struct DatesCitizen                                              
{
	public int age; // edad del ciudadano
	public Censo name; // enum nombre del ciudadano que llame name
}
